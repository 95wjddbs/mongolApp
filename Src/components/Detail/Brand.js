...
import { Container, Header, Content, Footer, FooterTab, Button, Text, Left, Body, Title, Right, View, Thumbnail, Tab, Tabs, List, ListItem } from 'native-base';
...
{/* @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ */}
        ...
        <Content>
            <View>
                <TouchableOpacity onPress={() =>{ props.navigation.navigate('brandDetail'); }}>
                    <View style={{backgroundColor:'#E3E3E3', padding:'40%', marginTop:-50}}></View>
                </TouchableOpacity>
